...
def main():
    ...
    parser = argparse.ArgumentParser(description='Create weather forecast metric visualizations')
    parser.add_argument('--metrics_dir', type=str, default='./metrics',
                      help='Directory containing metric files (default: ./metrics)')
    parser.add_argument('--output_dir', type=str, default=None,
                      help='Directory to save plots (default: None, will use metrics_dir/plots/)')
    args = parser.parse_args()
    
    logger.info(f"Metrics directory: {args.metrics_dir}")
    logger.info(f"Output directory: {args.output_dir or 'auto (metrics_dir/plots)'}")
    
    try:
        # Create visualizer
        visualizer = WeatherBench2Visualizer(args.metrics_dir, args.output_dir)
